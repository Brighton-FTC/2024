...
@Autonomous(name = "Test for Forward Speed", group = "speed-test")
public class forwardSpeedTest extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Odometry position: ", mecanumDriveOdometry.getPoseMeters());
        telemetry.update();
    }
}
